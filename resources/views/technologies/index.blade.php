                                ...
                                <x-datatables.action-link class="btn btn-primary"
                                    ...
                                    @if( $technology->deleted_at == null )
                                        <x-datatables.confirm
                                            ...
                                            icon="question"
                                            :message="__('translations.categories.labels.destroy-question', ['name' => $technology->name] )"
                                            ...
                                            @else
                                                <x-datatables.confirm
                                                    ...
                                                    :cancel-text="__('translations.buttons.no')" cancel-class="btn btn-secondary ms-2"
                                                    icon="question"
                                                    :message="__('translations.categories.labels.restore-question', ['name' => $technology->name] )"
